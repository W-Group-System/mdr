...
<div class="wrapper wrapper-content">
    <div class="row">
        ...
        @foreach ($departmentKpiGroup as $dptGroupData)
            @if($dptGroupData->id == 1)
                <div class="col-lg-12">
                    <div class="ibox float-e-margins" style="margin-top: 10px;">
                        <div class="ibox-title">
                            <p>{{ $dptGroupData->name }}</p>
                        </div>
            ...
            @if($dptGroupData->innovation->isNotEmpty())
                @if($dptGroupData->id == 5)
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins" style="margin-top: 10px;">
                            <div class="ibox-title">
                                <p><span class="period">{{ $dptGroupData->name }}</span></p>
