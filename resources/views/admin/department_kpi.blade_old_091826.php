                            ...
                            <tbody>
                                @foreach ($department_kpis as $department_kpi)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="label label-{{ $department_kpi->status == "Inactive" ? 'danger' : 'primary' }}">
                                                {{ $department_kpi->status == "Inactive" ? 'Inactive' : 'Active' }}
                                            </div>
                                        </td>
                                        <td>
                                            {{ \Carbon\Carbon::create()->month($department_kpi->month)->format('F') }}
                                        </td>
                                        <td>
                                            {{ \Carbon\Carbon::create()->year($department_kpi->year)->format('Y') }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
