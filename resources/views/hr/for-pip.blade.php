                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            View Files :
                                                            <span>
                                                                <a href="{{$mdrSummaryData->pipAttachments->filepath}}" target="_blank">{{$mdrSummaryData->pipAttachments->filename}}</a>
                                                            </span>
                                                        </div>
                                                        <div class="col-md-4">
                                                            Acknowledge by :
                                                        ...
                                                        {{-- <div class="col-md-4">
                                                            Status :
                                                            <span>{{$mdrSummaryData->pipAttachments->status}}</span>
                                                        </div> --}}
                                                        &nbsp;
                                                        @if($mdrSummaryData->pipAttachments->user_id != auth()->user()->id)
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <select name="acknowledge_by" id="acknowledgeBy" class="form-control cat" required>
                                                                    ...
                                                                    <option value="{{auth()->user()->id}}"{{auth()->user()->id==$mdrSummaryData->pipAttachments->acknowledge_by ? 'selected' : ''}}>{{auth()->user()->name}}</option>
                                                                </select>
                                                            </div>
                                                            {{-- <div class="col-md-4">
                                                                Status :
                                                                <select name="status" id="status" class="form-control cat" required>
                                                                    ...
                                                                    <option value="Waived" {{$mdrSummaryData->pipAttachments->status == 'Waived' ? 'selected' : ''}}>Waived</option>
                                                                    <option value="For PIP" {{$mdrSummaryData->pipAttachments->status == 'For PIP' ? 'selected' : ''}}>For PIP</option>
                                                                </select>
                                                            </div> --}}
                                                        @endif
                                                    </div>
