...
Route::group(['middleware' => ['auth','deactivate']], function () {
    ...
    # Departments
    Route::get('/departments', 'Admin\DepartmentController@index')->name('settings')->middleware('checkAccess');
    ...
    # MDR Groups
    Route::get('/mdr_group', 'Admin\MdrGroupController@index')->name('mdr')->middleware('checkAccess');
    ...
    # User Accounts
    Route::get('/user-accounts', 'Admin\UserController@index')->name('settings')->middleware('checkAccess');
    ...
    # For Acceptance MDR
    Route::get('/timeliness_approval', 'Approver\ForApprovalController@timelinessApproval')->name('timelinessApproval')->middleware('checkAccess');

    # For Approval MDR
    Route::get('/for_approval', 'Approver\ForApprovalController@index')->name('forApproval')->middleware('checkAccess');
    ...
    Route::get('department-approvers', 'DepartmentApproverController@index')->name('settings')->middleware('checkAccess');
